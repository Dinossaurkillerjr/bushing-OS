import { A as require_src, N as __toESM, O as textDecode, S as UINT32_LE, T as UINT8, _ as UINT16_BE, a as UnsupportedFileTypeError, d as INT32_BE, g as StringType, i as InternalParserError, j as __commonJSMin, n as CouldNotDetermineFileTypeError, v as UINT16_LE, w as UINT64_LE, x as UINT32_BE } from "./BasicParser-abWv7Jn3.js";
import { a as EndOfStreamError, i as fromWebStream, n as fromBlob, r as fromBuffer, t as fromFile } from "./lib-BzZUkTy8.js";
import { d as getUintBE, l as toRatio, n as decodeString } from "./Util-DKzu7sEP.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DiRju3vk.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BFPDrAMJ.js";
import { t as APEv2Parser } from "./APEv2Parser-DbAoDPD0.js";
import { r as hasID3v1Header } from "./ID3v1Parser-CaHVnsqd.js";
...
var debug$3 = (0, import_src.default)("tokenizer:inflate");
...
var ZipHandler = class ZipHandler {
	...
	async readCentralDirectory() {
		if (!this.tokenizer.supportsRandomAccess()) {
			debug$3("Cannot reading central-directory without random-read support");
			return;
		}
		debug$3("Reading central-directory...");
		const pos = this.tokenizer.position;
		const offset = await this.findEndOfCentralDirectoryLocator();
		if (offset > 0) {
			debug$3("Central-directory 32-bit signature found");
			...
			for (let n = 0; n < eocdHeader.nrOfEntriesOfSize; ++n) {
				...
				files.push(entry);
				debug$3(`Add central-directory file-entry: n=${n + 1}/${files.length}: filename=${files[n].filename}`);
			}
	...
	async unzip(fileCb) {
		...
		do {
			...
			if (zipHeader.dataDescriptor && zipHeader.compressedSize === 0) {
				...
				debug$3("Compressed-file-size unknown, scanning for next data-descriptor-signature....");
				...
				debug$3(`Found data-descriptor-signature at pos=${this.tokenizer.position}`);
				if (next.handler) await this.inflate(zipHeader, mergeArrays(chunks), next.handler);
			} else if (next.handler) {
				debug$3(`Reading compressed-file-data: ${zipHeader.compressedSize} bytes`);
				fileData = new Uint8Array(zipHeader.compressedSize);
				await this.tokenizer.readBuffer(fileData);
				await this.inflate(zipHeader, fileData, next.handler);
			} else {
				debug$3(`Ignoring compressed-file-data: ${zipHeader.compressedSize} bytes`);
				await this.tokenizer.ignore(zipHeader.compressedSize);
			}
			debug$3(`Reading data-descriptor at pos=${this.tokenizer.position}`);
	...
	async inflate(zipHeader, fileData, cb) {
		...
		debug$3(`Decompress filename=${zipHeader.filename}, compressed-size=${fileData.length}`);
...
var debug$2 = (0, import_src.default)("music-metadata:collector");
var TagPriority = [
	"matroska",
	"APEv2",
	"vorbis",
...
var mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-D6sSL04y.js")).MpegParser;
	}
};
//#endregion
...
var apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DbAoDPD0.js").then((n) => n.n)).APEv2Parser;
	}
};
//#endregion
...
var asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BhkU22o0.js")).AsfParser;
	}
};
//#endregion
...
var dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-B-diKM8y.js")).DsdiffParser;
	}
};
//#endregion
...
var aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-DffGuOOn.js")).AIFFParser;
	}
};
//#endregion
...
var dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-mq3Q58fQ.js")).DsfParser;
	}
};
//#endregion
...
var flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-NazcgcxT.js").then((n) => n.n)).FlacParser;
	}
};
//#endregion
...
var matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-DmlQRCqp.js")).MatroskaParser;
	}
};
//#endregion
...
var mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-Csh1GLsi.js")).MP4Parser;
	}
};
//#endregion
...
var musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DOM5udOW.js")).MusepackParser;
	}
};
//#endregion
...
var oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BhLppzNU.js")).OggParser;
	}
};
//#endregion
...
var wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DnQHmsth.js")).WavPackParser;
	}
};
//#endregion
...
var riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-CnPYpXW7.js")).WaveParser;
	}
};
//#endregion
//#region node_modules/music-metadata/lib/ParserFactory.js
var debug$1 = (0, import_src.default)("music-metadata:parser:factory");
...
*/
var debug = (0, import_src.default)("music-metadata:parser");
/**
...
app.whenReady().then(() => {
	protocol.registerFileProtocol("musicos", (request, callback) => {
		const filePath = url.fileURLToPath("file://" + request.url.slice(10));
...
ipcMain.handle("dialog:openFolder", async () => {
	...
	return files.filter((f) => allowed.some((ext) => f.toLowerCase().endsWith(ext))).map((f) => path.join(folderPath, f));
});
ipcMain.handle("scanner:parseMetadata", async (_, paths) => {
	const items = [];
	for (const filePath of paths) try {
		const metadata = await parseFile(filePath);
		let coverArtUrl = void 0;
